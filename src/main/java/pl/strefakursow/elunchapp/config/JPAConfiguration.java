...
@Configuration
@EnableJpaRepositories("pl.strefakursow.elunchapp")
...
public class JPAConfiguration {
    ...
    public DataSource getDataSource() {
        ...
        dataSourceBuilder.url("jdbc:mysql://localhost:3306/elunchapp?;encrypt=true;instanceName=instance1;integratedSecurity=true;<more properties as required>;\n" + "\n");
        dataSourceBuilder.username("strefa");
        dataSourceBuilder.password("kurswow");
